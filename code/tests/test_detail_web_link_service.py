...
class DetailWebLinkServiceTest(unittest.TestCase):
    @patch('app.services.detail.web_link_service.get_avfan_actor_page_url', return_value='https://avfan.example/casts/actor-123')
    @patch('app.services.detail.web_link_service.get_avfan_actor_search_url', return_value='https://avfan.example/search?q=actor')
    ...
    @patch('app.services.detail.web_link_service.get_avfan_code_prefix_url', return_value='https://avfan.example/series/ipx?page=1')
